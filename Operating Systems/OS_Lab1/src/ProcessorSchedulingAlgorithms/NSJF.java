...
public class NSJF extends Scheduler{
    ...
    private void N_shortestJobFirst(ArrayList<Process> jobs){
        ...
        while(true) {
            ...
            if (!super.readyQueueEmpty()) {
                ...
                //if the RQ is of size 1, the head of the RQ will be the shortest process
                if (super.readyQueueSize() == 1) {
                    ...
                    with the smallest CPU Burst. Set that process as the shortest process.
                     */
                ...
                //if the current process still have CPU Burst to complete, the process running
                ...
                if (shortestProcess.getCPUBurstLeft() == 0) {
                    ...
                    shortestProcess.setWaitTime(shortestProcess.getCompletionTime() - (shortestProcess.getArrivalTime()
                            + shortestProcess.getCPUBurst()));
    ...
    public void runNSJF(ArrayList<Process> jobs) {
        double avgWT;
        System.out.println();
        System.out.println("Scheduling Algorithm 3: Non-Preemptive Shortest Job First");
        N_shortestJobFirst(jobs); //runs the sjf algorithm
        //calculate averages
